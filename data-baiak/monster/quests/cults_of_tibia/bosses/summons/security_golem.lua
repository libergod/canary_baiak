...
monster.description = "a secutiry golem"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -440, length = 6, spread = 4, effect = CONST_ME_PURPLEENERGY, target = false},
