...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -1200, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -2000, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false}
}
