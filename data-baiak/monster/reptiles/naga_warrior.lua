...
monster.attacks = {
	...
	{name = "nagadeathattack", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -360, maxDamage = -415, target = true},	-- death_strike
