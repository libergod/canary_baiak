local bossRoom = MoveEvent()

function bossRoom.onStepIn(creature, item, position, fromPosition)
...
bossRoom:type("stepin")
for actionRange = 30000, 30020 do
	bossRoom:aid(actionRange)
end
bossRoom:register()