local config = {
    ...
    rouletteOptions = {
        rareItemChance_broadcastThreshold = 2000,
        ignoredItems = {23923, 24289, 24287, 15487}, -- if you have tables/counters/other items on the roulette tiles, add them here
    ...
    prizePool = {
        {itemId = 9058, count = {1, 10},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 3360, count = {1, 1},    chance = 9000 }, -- crown legs
        {itemId = 3555, count = {1, 1},    chance = 8500 }, -- golden boots
        {itemId = 3365, count = {1, 1},    chance = 7500 }, -- golden helmet
        {itemId = 37317, count = {1, 2},    chance = 4000 }, -- roulette token
        {itemId = 3364, count = {1, 1},    chance = 3000 }, -- golden legs
        {itemId = 34109, count = {1, 1},    chance = 1500 }, -- bag you desire
        {itemId = 39546, count = {1, 1},    chance = 500  }  -- primal bag
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(1116, 965, 7),
        Position(1117, 965, 7),
        Position(1118, 965, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(1119, 965, 7),
        Position(1120, 965, 7),
        Position(1121, 965, 7),
    }
