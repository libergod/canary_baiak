local itemFunctions = {
	...
	["uniqueid"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::UNIQUEID, target) end },
	["unique"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::UNIQUEID, target) end },
	["uid"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::UNIQUEID, target) end },
	["description"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::DESCRIPTION, target) end },
	["desc"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::DESCRIPTION, target) end },
	["name"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::NAME, target) end },
	...
	["attack"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::ATTACK, target) end },
	["defense"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::DEFENSE, target) end },
	["extradefense"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::EXTRADEFENSE, target) end },
	["charge"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::CHARGES, target) end },
	["armor"] = { isActive = true, targetFunction = function (item, target) return item:setAttribute(ItemAttribute_t::ARMOR, target) end }
}
