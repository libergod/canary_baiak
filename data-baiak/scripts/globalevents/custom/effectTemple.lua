...
local effectTempleShow = GlobalEvent("effectTempleShow")
function effectTempleShow.onThink(interval, lastExecution)
...
effectTempleShow:interval(2000)
effectTempleShow:register()