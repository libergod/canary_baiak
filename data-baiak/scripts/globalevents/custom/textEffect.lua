    ...
    {position = Position(982, 1208, 7), text = "MiniGames", effect = 18, say = true, color = math.random(1,255)},
    ...
    {position = Position(1418, 1309, 8), text = "Templo", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(1426, 1309, 8), text = "Quests", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(1422, 1281, 7), text = "Templo", effect = 40, say = true, color = math.random(1,255)},
    ...
    -- Alavancas
    {position = Position(982, 1203, 7), text = "AddonDoll", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(983, 1203, 7), text = "Dodge", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(984, 1203, 7), text = "Critical", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(985, 1203, 7), text = "SuperUP", effect = 40, say = true, color = math.random(1,255)},
    {position = Position(991, 1204, 7), text = "Stamina", effect = 40, say = true, color = math.random(1,255)},
	
	{position = Position(977, 1210, 7), text = "Forge System\n", effect = 40, say = true, color = math.random(1,255)},
}
